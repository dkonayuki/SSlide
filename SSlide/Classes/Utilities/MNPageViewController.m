...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView {
    ...
    CGFloat ratio = (scrollView.contentOffset.x - bounds.size.width) / bounds.size.width;
    ...
    if (self.delegate && [self.delegate respondsToSelector:@selector(mn_pageViewController:willPageFromViewController:withRatio:)]) {
        ...
        [self.delegate mn_pageViewController:self willPageFromViewController:self.viewController withRatio:ratio];
    }
}
